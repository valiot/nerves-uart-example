defmodule NervesUartExample.MixProject do
  use Mix.Project
  ...
  # invoke NervesUartExample.start/2 when running on a target.
  ...
  def application(_target) do
    [
      mod: {NervesUartExample.Application, []},
